    ...
    <div className="container mx-auto max-w-7xl min-w-[380px] px-6">
      <div
        className={`flex flex-col items-center ${
          publicConfig.chainEnv === "emulator" ? "mt-0" : "mt-20"
        } mb-20 gap-y-12 justify-stretch`}
      >
        {publicConfig.chainEnv === "emulator" ? (
          <div className="flex flex-col px-3 py-2 bg-drizzle-light rounded-xl text-base">
            ...
            <label>
              1. The emulator started with{" "}
              <code className="text-sm">--contracts</code>
            </label>
            <label>
              2. The emulator started WITHOUT{" "}
              <code className="text-sm">--simple-addresses</code>
            </label>
