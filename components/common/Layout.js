        ...
        <div className="px-5 flex flex-col gap-y-1">
          ...
          <div className="flex gap-x-2 items-center">
            ...
            <DocumentDuplicateIcon
              className="text-gray-700 hover:text-drizzle w-6 h-6"
              onClick={async () => {
          ...
          {bookmark ? (
            <div className="flex gap-x-2 items-center">
              <label
                className={`font-semibold text-xs px-2 py-1 leading-4 rounded-full text-black bg-drizzle`}
              >
                Note
              </label>
